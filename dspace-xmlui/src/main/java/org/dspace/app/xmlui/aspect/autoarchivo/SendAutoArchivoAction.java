 ...
 * @author lucas
 */
public class SendAutoArchivoAction extends AbstractAction{
            ...
            String source, Parameters parameters) throws Exception
    {
        ...
        String eperson = null;
        String name_eperson = null;
        if (loggedin != null){
            eperson = loggedin.getEmail();
            name_eperson = loggedin.getFullName();
        }
        ...
        if ((address == null) || address.equals("") || (comunidad == null) || comunidad.equals("")){
        ...
        Email email = Email.getEmail(I18nUtil.getEmailFilename(context.getCurrentLocale(), "autoarchivo"));
        ...
        email.addArgument(nombre);
        email.addArgument(comunidad);
        email.addArgument(observaciones);   // The feedback itself
